...
public class Panel2_Listener extends Mouse_Listener {

	public void mousePressed(MouseEvent e) {
		Simulation.drag = Simulation.net.selectDrag(e.getX(), e.getY());
		if (!Simulation.drag) {
			System.out.println("进入mouse-pressed");
			// Simulation.drag = Simulation.net.selectDrag(e.getX(),e.getY());
			return;
		}
			...
			if (Simulation.drag) {
				// System.out.println("MOUSE_DRAG----drag ture");
	...
	public void mouseClicked(MouseEvent e)  {
		...
		case STEP_BY_STEP:
			switch (Simulation.net.run(e.getX(), e.getY())) {
