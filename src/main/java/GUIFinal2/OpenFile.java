	...
	public void actionPerformed(ActionEvent e) {
	 ...
	 public void readJSONFile(File file) throws org.json.simple.parser.ParseException{
		 ...
		 try {
			 ...
			 Object obj = parser.parse(new FileReader("/Users/jwang/Documents/workspace/JSON/"+file.getName()));	 
			...
			//遍历places
			 ...
			 while(transItr2.hasNext()) {
				 System.out.println("进入transition");
			 ...
			 while(transItr22.hasNext()) {
				// System.out.println("进入第二遍transition");
